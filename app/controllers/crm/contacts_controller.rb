module Crm
  class ContactsController < ::ApplicationController
    ...
    def initialize_data
      Contact.searchable_columns :contact_name => ["crm_contacts.name", "Name"], :contact_email => ["crm_contacts.email", "Email"], :contact_phone => ["crm_contacts.phone", "Phone"], :contact_account_name => ["company_accounts.name", "Account"]
    end
